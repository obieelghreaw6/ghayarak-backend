...
-- Added: parts weren't only for cars — trucks and motorbikes are a real,
-- previously-invisible segment of the Libyan market. Defaults existing
-- rows to 'car' since that's what they all were before this column
-- existed.
